                           ...
                           const Expr its, const Expr ite)
{
    ...
    auto tmpzx = w(i, k+1, j) - w(i, k, j);
    target(i, k, j) = tmpzx * rdzw(i, k, j);
    return target;
}
...
int main(int argc, char** argv)
{
    ...
    Buffer<double,3> w({i_range+1, k_range+1, j_range+1}, "w"), w_g(w);
