...
SUBROUTINE viscosity_kernel(x_min,x_max,y_min,y_max,    &
  ...
  REAL(KIND=8), DIMENSION(x_min-2:x_max+2)                     :: celldx !2p
  REAL(KIND=8), DIMENSION(y_min-2:y_max+2)                     :: celldy !2p
  REAL(KIND=8), DIMENSION(x_min-2:x_max+2,y_min-2:y_max+2)     :: density0 !1p
  REAL(KIND=8), DIMENSION(x_min-2:x_max+2,y_min-2:y_max+2)     :: pressure !4p
  REAL(KIND=8), DIMENSION(x_min-2:x_max+2,y_min-2:y_max+2)     :: viscosity !out
  REAL(KIND=8), DIMENSION(x_min-2:x_max+3,y_min-2:y_max+3)     :: xvel0, & !4p
                                                                  yvel0 !4p
