MODULE accelerate_kernel_loop84_mod
CONTAINS
SUBROUTINE accelerate_kernel_loop84(j,k,pressure,stepbymass,x_max,x_min,y_max,y_min,yarea,yvel0,yvel1)
INTEGER :: j
INTEGER :: k
INTEGER :: x_max
INTEGER :: x_min
...
END MODULE accelerate_kernel_loop84_mod
