MODULE flux_calc_kernel_loop89_mod
CONTAINS
SUBROUTINE flux_calc_kernel_loop89(j,k,dt,vol_flux_x,x_max,x_min,xarea,xvel0,xvel1,y_max,y_min)
INTEGER :: j
INTEGER :: k
REAL(kind=8) :: dt
INTEGER :: x_max
...
END MODULE flux_calc_kernel_loop89_mod
