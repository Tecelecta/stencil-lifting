MODULE accelerate_kernel_loop86_mod
CONTAINS
SUBROUTINE accelerate_kernel_loop86(j,k,stepbymass,viscosity,x_max,x_min,y_max,y_min,yarea,yvel1)
INTEGER :: j
INTEGER :: k
INTEGER :: x_max
INTEGER :: x_min
...
END MODULE accelerate_kernel_loop86_mod
