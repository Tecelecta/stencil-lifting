SUBROUTINE advec_mom_kernel_loop107(mom_flux,node_mass_post,node_mass_pre,vel1,x_max,x_min,y_max,y_min)
    INTEGER :: j
    INTEGER :: k
    INTEGER :: x_max
    INTEGER :: x_min
    ...
    REAL(kind=8), DIMENSION(x_min:(x_max+1), y_min:(y_min+1)) :: vel1
    DO k = y_min, y_max + 1
        DO j = x_min, x_max + 1
