SUBROUTINE flux_calc_kernel_loop90(dt,vol_flux_y,x_max,x_min,y_max,y_min,yarea,yvel0,yvel1)
INTEGER :: j
INTEGER :: k
REAL(kind=8) :: dt
INTEGER :: x_max
...
DO k = y_min, y_max + 1
DO j = x_min, x_max
vol_flux_y(j,k) = 0.25_8 * dt * yarea(j,k) * (yvel0(j,k) + yvel0(j + 1,k) + yvel1(j,k) + yvel1(j + 1,k))
END DO
END DO
END SUBROUTINE 
