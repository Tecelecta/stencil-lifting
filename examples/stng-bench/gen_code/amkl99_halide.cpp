...
extern "C" {
    void advec_mom_kernel_loop99_(double *post_vol,
                                  double *pre_vol, 
                                  double *vol_flux_y,
                                  double *volume,
...
int main(int argc, char** argv)
{
    ...
    // --------------------------- advec_mom_kernel_loop99 kernel --------------------------
    // printf("advec_mom_kernel_loop99 kernel start!\n");
    ...
    advec_mom_kernel_loop99_(post_vol_, pre_vol_, 
                             vol_flux_y_, volume_, 
